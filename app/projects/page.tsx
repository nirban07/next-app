...
const page = () => {
	return (
		<div className="pt-32 p-12 md:p-24 md:pt-32  items-center  gap-y-5  md:gap-x-20 md:h-full  flex md:flex-wrap flex-col md:flex-row  rounded-xl bg-gradient-to-r from-orange-500 to-green-500 ">
